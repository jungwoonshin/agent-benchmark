...
class ContentSummarizer:
    ...
    def summarize_single_result(
        ...
        """
        Summarize content from a single search result.
        ...
        Args:
            ...
            content_type: Type of content (pdf, web_page, file, etc.).
        ...
        try:
            ...
            system_prompt = f"""You are an expert at summarizing {content_type} content for problem-solving.
Given content from a search result, create a focused summary that extracts key information relevant to the problem and subtask.
...
Return a well-structured summary that preserves critical details and is organized for easy understanding."""
...
Summarize this content, extracting key information relevant to solving the problem and completing the subtask."""
